...
**Реализован** (`chat-page.component`, заменил stub 2026-06-18).
...
- Рендер ответа — `ngx-markdown` (санитайз), тема Super Productivity; пузыри юзер/ассистент,
  автоскролл, кнопка «стоп», Enter — отправить.

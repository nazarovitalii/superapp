-- ⚠️ SUPERSEDED 2026-06-22 миграцией realtime 009 (бандл
--    applied/2026-06-22-realtime-match-pipeline-009-012.sql): те же имена объектов,
--    inline pg_notify убран (централизован в 010), price_drop получил currency/period-гард.
--    Файл оставлен как исторический след первой (моей) версии RT-2. Не применять повторно.
-- ============================================================================

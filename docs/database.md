...
> Источник истины — живой `pg_get_functiondef('public.get_feed')`, не блок ниже. Сигнатура сейчас **46 арг**
> (хвост: `…, p_is_vastu boolean, p_scope text DEFAULT 'all', p_my_status text DEFAULT 'all'`).
